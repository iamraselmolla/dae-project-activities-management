...
const WhyweUs2 = () => {
    return (
        <section className='py-24'>
            <div className='mx-auto items-center max-w-7xl px-2 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-24'>
                <div className="">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <WhyThisSoftwareIcon heading={'উদ্বুদ্ধকরণ ভ্রমণ'} text={'প্রকল্পের উদ্বুদ্ধকরণ ভ্রমণ, তারিখ ও স্থানসহ ছবি এবং মন্তব্য সংরক্ষণ'} Icon={IoBusOutline} />
