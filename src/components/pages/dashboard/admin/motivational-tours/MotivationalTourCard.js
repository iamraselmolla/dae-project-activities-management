...
const MotivationalTourCard = ({ data }) => {
  ...
  const handleDeleteTour = async () => {
    if (
      window.confirm(
        `আপনি কি ${projectInfo?.short} প্রকল্পের ${season}/${fiscalYear} মৌসুমের ${place} নামক জায়গার উদ্বুদ্ধকরণ ভ্রমণটির তথ্য মুছে ফেলতে চান?`
      )
    ) {
      try {
        setLoading(true);
...
export default MotivationalTourCard;
