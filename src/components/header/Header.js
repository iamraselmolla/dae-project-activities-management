      ...
      <div className="navbar mx-auto px-2 sm:px-6 lg:px-8">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-sm theme-bg flex flex-col gap-4 dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 ${!showMenu ? "block" : "hidden"
                }`}
            >
                    ...
                    <>
                      ...
                      >
                        ...
                        <NavLink
                          ...
                          className={({ isActive, isPending }) =>
                            isPending
                              ? "pending"
                              : isActive
                                ? "active bg-white text-black rounded-md px-3 py-2 text-sm font-medium"
                        ...
                        <Link
                          ...
                          className="block font-extrabold px-3 py-2 text-sm text-white hover:bg-red-600 hover:text-white"
                          role="menuitem"
                          tabIndex="-1"
                          id="user-menu-item-2"
                        >
