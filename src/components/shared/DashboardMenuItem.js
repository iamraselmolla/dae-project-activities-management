        ...
        <NavLink
            ...
            className={({ isActive, isPending }) =>
                isPending
                    ...
                    : isActive
                        ? "rounded-xl px-3 md:px-2 my-2 lg:w-full md:w-full w-auto py-2 md:py-4 flex items-center gap-2 md:gap-4 ps-0 justify-center md:ps-4 lg:ps-6  font-bold  bg-blue-200"
