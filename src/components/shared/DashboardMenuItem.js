        ...
        <NavLink
            ...
            className={({ isActive, isPending }) =>
                isPending
                    ...
                    : isActive
                        ? "rounded-xl px-3 md:px-2 lg:w-full md:w-full w-auto py-2 md:py-4 flex items-center gap-2 md:gap-4 md:ps-0 lg:justify-start md:justify-start justify-center  lg:ps-6  font-bold  theme-bg"
